        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li
              ...
              :key="index"
            >
              {{ attr.split(":")[1] }}<i @click="removeAttr">×</i>
            </li>
          </ul>
        </div>
...
export default {
  ...
  // 当从首页有两种方式可以跳转到search，一个是点击三级分类TypeNav，接收到了query参数，
  // 另一个是input中输入，携带params参数跳转到search，
  // 所以要在search路由组件beforeMount将上面两个参数传递给search组件
  beforeMount() {
    // 简写
